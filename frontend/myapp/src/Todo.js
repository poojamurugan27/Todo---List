...
const TodoList = () => {
    ...
    return (
        <div style={{ backgroundImage: 'url(https://cdn.pixabay.com/photo/2018/06/20/08/05/august-3485999_640.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' , height:'690px'}}>
